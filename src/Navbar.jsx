    ...
    <div className="navbar-box">
      ...
      {currentUser ? (
        <div className="d-flex justify-content-end align-items-center">
          <span className="me-3">Hello, {currentUser.name}</span>
          <button 
            type="button" 
            className="btn btn-outline-danger border rounded-pill" 
            id='button'
        ...
        <NavLink className={(e) => e.isActive ? "green" : "red"} to="/signin" id='link'>
          <div className="d-flex justify-content-end align-items-center">
            <button type="button" className="btn btn-info border rounded-pill" id='button'>Sign in</button>
          </div>
        </NavLink>
